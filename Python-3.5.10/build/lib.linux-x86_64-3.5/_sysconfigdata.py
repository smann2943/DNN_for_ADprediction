...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -shared -Wl,-rpath=/opt/python3.5/lib -fprofile-generate',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-rpath=/opt/python3.5/lib',
 ...
 'COVERAGE_INFO': '/workspaces/DNN_for_ADprediction/Python-3.5.10/coverage.info',
 'COVERAGE_REPORT': '/workspaces/DNN_for_ADprediction/Python-3.5.10/lcov-report',
 ...
 'LDFLAGS': '-Wl,-rpath=/opt/python3.5/lib -fprofile-generate',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.5m.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -Wl,-rpath=/opt/python3.5/lib -fprofile-generate',
 'LDVERSION': '3.5m',
 'LIBC': '',
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
              '-Wstrict-prototypes',
 'PY_CFLAGS_NODIST': '-Werror=declaration-after-statement -fprofile-generate',
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -Wstrict-prototypes '
                   '-Werror=declaration-after-statement -fprofile-generate -I. '
                   '-I./Include -fPIC -DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_LONG_LONG': '"ll"',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-rpath=/opt/python3.5/lib -fprofile-generate',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 'Py_HASH_ALGORITHM': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/workspaces/DNN_for_ADprediction/Python-3.5.10',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/workspaces/DNN_for_ADprediction/Python-3.5.10 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/workspaces/DNN_for_ADprediction/Python-3.5.10 '
 ...
 'abs_builddir': '/workspaces/DNN_for_ADprediction/Python-3.5.10',
 'abs_srcdir': '/workspaces/DNN_for_ADprediction/Python-3.5.10',
